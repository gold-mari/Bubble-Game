...
public class BubbleSpawner : MonoBehaviour
{
    ...
    void Update()
    {
        if ( Input.GetKeyDown(KeyCode.A) ) {
            SpawnBubble(Bubble.Bubble_Color.Red);
        }

        if ( Input.GetKeyDown(KeyCode.S) ) {
            SpawnBubble(Bubble.Bubble_Color.Blue);
        }

        if ( Input.GetKeyDown(KeyCode.D) ) {
            SpawnBubble(Bubble.Bubble_Color.Yellow);
        }

        if ( Input.GetKeyDown(KeyCode.F) ) {
            SpawnBubble(Bubble.Bubble_Color.Green);
        }
    }

    private void SpawnBubble(Bubble.Bubble_Color color) {
